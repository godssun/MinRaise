	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http
				...
				.authorizeHttpRequests(auth -> auth
						.requestMatchers("/", "/api/users/register", "/api/users/**", "/api/calculations/raise", "/api/games/**", "/api/bets/**", "/api/players/**",
								"/swagger-ui/**", "/v3/api-docs/**").permitAll()) // 나머지 요청은 인증을 필요로 합니다.
